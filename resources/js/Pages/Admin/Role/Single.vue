...
<template>
    ...
    >
        ...
        <td class="px-4 py-3 w-[400px]">
          <span v-for="permission in role.permissions" :key="permission.id" class="bg-blue-100 text-blue-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded">
            {{ permission.name }}
          </span>
        </td>
